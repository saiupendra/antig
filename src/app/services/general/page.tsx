...
export default function GeneralDentistryPage() {
  ...
  const serviceData = {
    ...
    heroImage: "/images/services/pages/general-dentistry.webp",
    
    seo: {
      title: "Best General Dentistry in Anandbagh, Moula Ali, Hyderabad | Family Dental Care - Dr. Sri Sushma Multispeciality Dental Clinic",
      description: "Get comprehensive general dentistry services in Anandbagh at Dr. Sri Sushma Multispeciality Dental Clinic. Dental checkups, cleanings, fillings, extractions, and preventive care for all ages. Book your family dental appointment today!",
      keywords: "general dentistry Anandbagh, family dentist, dental checkup, teeth cleaning, dental care, general dental services, preventive dentistry, routine dental care, dental clinic Anandbagh",
      canonical: "https://www.drsrisushmadentalclinic.com/services/general/"
    },
    
    description: "Experience complete dental care for your entire family at Dr. Sri Sushma Multispeciality Dental Clinic in Anandbagh. Our general dentistry services cover all aspects of oral health including routine checkups, professional cleanings, cavity treatment, tooth extractions, gum disease treatment, dental X-rays, and preventive care. We provide comprehensive diagnosis and treatment for dental problems ranging from simple toothaches to complex oral health issues. With gentle care and modern technology, we make dentistry comfortable for patients of all ages - from children to seniors.",
  ...
  useEffect(() => {
    ...
    const breadcrumbData = {
      ...
      "@type": "BreadcrumbList",
      "itemListElement": [
        { "@type": "ListItem", "position": 1, "name": "Home", "item": "https://www.drsrisushmadentalclinic.com/" },
        { "@type": "ListItem", "position": 2, "name": "Services", "item": "https://www.drsrisushmadentalclinic.com/services/" },
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-700 mb-6 sm:mb-8 max-w-2xl mx-auto leading-relaxed px-4">
                {serviceData.subtitle} at Dr. Sri Sushma Multispeciality Dental Clinic - Anandbagh's Trusted Family Dentist
              </p>
