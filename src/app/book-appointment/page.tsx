        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-700">
              Schedule your visit to Dr. Sri Sushma Multispeciality Dental Clinic. We're here to help you achieve a healthy, beautiful smile.
            </p>
          </div>
        </div>
      </section>
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">+91 79958 15454</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">info@drsrisushmadentalclinic.com</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Sanjay Apartment, 24-88/51/1, Anandbagh, Moula Ali, Hyderabad, Secunderabad, Telangana 500047</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">We are open 365 days</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
