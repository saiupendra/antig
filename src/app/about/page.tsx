...
export const metadata: Metadata = {
  title: "About Us | Best Dental Clinic in Anandbagh & Moula Ali",
  description: "Learn about Dr. Sri Sushma Dental Clinic. 15+ Years of specific experience in Root Canal, Implants & Braces. Top rated lady dentist in Secunderabad.",
  keywords: "About Dr Sri Sushma, Dentist Profile, Dental Clinic History, Lady Dentist in Anandbagh, Best Dental Team Secunderabad, Dental Clinic Reviews",
  alternates: {
    canonical: "https://www.drsrisushmadentalclinic.com/about/",
  },
}
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              About Dr. Sri Sushma Multispeciality Dental Clinic
            </h1>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-700">
                Dr. Sri Sushma Multispeciality Dental Clinic was founded in 2025 with a simple mission: to provide
