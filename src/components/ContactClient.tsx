    ...
    const contactInfo = [
        {
            icon: Phone,
            title: "Phone",
            details: ["+91 97035 83546", "+91 97035 83546 (Emergency)"],
            action: "tel:+919703583546"
        },
        {
            icon: Mail,
            title: "Email",
            details: ["info@drsrisushmadentalclinic.com"],
            action: "mailto:info@drsrisushmadentalclinic.com"
        },
        {
            icon: MapPin,
            title: "Address",
            details: ["Sanjay Apartment, 24-88/51/1, Anandbagh, Moula Ali, Hyderabad, Secunderabad, Telangana 500047"],
            action: "https://maps.app.goo.gl/5f44hv9XravRpCgK9"
        },
        {
            icon: Clock,
            title: "Working Hours",
            details: ["Mon-Sun: 9:00 AM - 9:00 PM", "Open 365 Days"],
            action: null
        }
    ]
                        ...
                        <div className="space-y-6">
                            ...
                            <Card className="overflow-hidden">
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Sanjay Apartment, 24-88/51/1, Anandbagh, Moula Ali, Hyderabad, Secunderabad, Telangana 500047
                                    </CardDescription>
                                </CardHeader>
                                <CardContent className="p-0">
                                    <div className="aspect-video bg-gray-200">
                                        <iframe
                                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d988.676634171378!2d78.5410819695856!3d17.458117398965083!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x501c598a4c3e6a9%3A0xc06487d0c37e348c!2sDr%20Sri%20Sushma%20Multispecialty%20Dental%20Clinic!5e1!3m2!1sen!2sin!4v1764271699523!5m2!1sen!2sin"
                                            width="100%"
                                            height="100%"
                                            style={{ border: 0 }}
                                            allowFullScreen
