...
export default function ServicesClient() {
    ...
    const treatments = [
        ...
        },
        {
            ...
            description: "Restore your confidence and comfort with natural-looking, custom-fit dentures for complete, partial, or implant-supported tooth replacement.",
            link: "/services/dentures"
        },
        {
            title: "Laser Treatment",
            image: "/images/services/Laser-Treatment.webp",
            description: "Achieve painless, precise dental treatment with advanced laser technology for faster healing, comfort, and smile perfection.",
            link: "/services/laser-treatment"
        },
        {
            title: "Advanced Gum Treatment",
            image: "/images/services/Advanced-Gum-Treatment.webp",
            description: "Advanced gum treatment gently removes deep infection, tightens loose gums, and protects your teeth from future bone loss",
            link: "/services/gum-treatment/"
        },
        {
            title: "Emergency Care",
            image: "/images/services/Emergency-Care.webp",
            description: "Emergency dentist in Hyderabad—walk in or call now for instant pain relief and urgent dental care any time, any day",
    ...
    const faqs = [
        ...
        },
        {
            ...
            answer: "Yes, at Dr. Sri Sushma Multispeciality Dental Clinic we accept most major dental insurance plans including ICICI Lombard, Star Health, Max Bupa, HDFC Ergo, and more. Our team will help verify your coverage and maximize your benefits. We also offer flexible payment options and EMI facilities for treatments not covered by insurance.",
            link: null
        },
        {
        ...
        },
        {
            ...
            answer: "Yes, at Dr. Sri Sushma Multispeciality Dental Clinic we provide same-day emergency dental services for urgent issues like severe toothache, broken teeth, knocked-out teeth, dental injuries, abscesses, and lost fillings. Call us immediately at +91 98765 43210 for emergency appointments.",
            link: "/contact"
        },
        {
            question: "Is teeth whitening safe and how long does it last?",
            answer: "Yes, professional teeth whitening performed at our Dr. Sri Sushma Multispeciality Dental clinic is completely safe and effective. We use FDA-approved whitening agents and follow proper protocols. Results typically last 1-3 years depending on your oral hygiene and lifestyle habits.",
            link: null
        },
        {
    ...
    return (
        <>
                    ...
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in animation-delay-300">
                            <Button size="lg" className="bg-gradient-to-r from-teal-600 to-blue-600 hover:from-teal-700 hover:to-blue-700 text-white shadow-lg">
                                <Link href="https://wa.me/917995815454" className="flex items-center gap-2">
                            ...
                            <Button size="lg" variant="outline" className="border-2 border-teal-600 text-teal-600 hover:bg-teal-50 bg-white/80 backdrop-blur-sm">
                                <a href="tel:+917995815454" className="flex items-center gap-2">
                            ...
                            return (
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <ChevronDown
                                            className={`w-5 h-5 text-teal-600 transition-transform flex-shrink-0 mt-1 ${openFaq === actualIndex ? 'rotate-180' : ''
                                                }`}
                                        />
                                    </button>
                                    {openFaq === actualIndex && (
            ...
            <CTASection
                variant="default"
                showStats={false}
                title="Ready to Transform Your Smile with Dr. Sri Sushma Multispeciality Dental Clinic?"
                subtitle="Book your free appointment today and experience world-class dental care"
            />
        </>
    )
}
